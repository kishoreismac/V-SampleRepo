...
param existingDnsZones object = {
  'privatelink.services.ai.azure.com': resourceGroup().name
  'privatelink.openai.azure.com': resourceGroup().name
  'privatelink.cognitiveservices.azure.com': resourceGroup().name
  'privatelink.search.windows.net': ''
  'privatelink.blob.${environment().suffixes.storage}': resourceGroup().name
  'privatelink.documents.azure.com': resourceGroup().name
}
